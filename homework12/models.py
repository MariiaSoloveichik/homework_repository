...
Homework 6 (Teachers, Students, Homework and others).
...
a migration file (separate) creating at least
...
Creating database main.db using SQLAlchemy and creating tables
homework, homework_results, students, teachers in it.
Also starting session which should be closed.
"""
import datetime
