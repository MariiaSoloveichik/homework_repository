...
def tic_tac_toe_checker(board: List[List]) -> str:
    """
    Function that checks if the are some winners.
    If there is "x" winner, function return "x wins!"
    If there is "o" winner, function return "o wins!"
    If there is a draw, function return "draw!"
    If board is unfinished, function return "unfinished!"
    """
